...
dataset_info = {
    ...
    "1 Variabel": {"folder": "1_var", "prefix": "all_data_1var_w500"},
...
def plot_comparative_charts_monthly(tahun_start: int, bulan_start: int, tahun_end: int, bulan_end: int, selected_station_name: str):
    ...
    fig_scatter, axes = plt.subplots(1, 4, figsize=(24, 6))
    ...
    if not selected_models or not metrics_to_plot:
        ...
        if not dfs_to_plot:
            ...
            color_map = {
                ...
                'Rainfall (Ground Truth)': 'mediumvioletred', 'ch_pred (1 Variabel)': 'mediumvioletred',
                'error_bias (1 Variabel)': 'darkmagenta', 'absolute_error (1 Variabel)': 'purple',
